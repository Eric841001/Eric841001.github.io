...
```mermaid
flowchart LR
  Intent["Search intent<br/>problem, technology,<br/>project asset"]:::phase
  Landing["Topic landing<br/>Microsoft 365, Security,<br/>Copilot, AI Agent"]:::phase
  Guide["Practical guide<br/>architecture, governance,<br/>migration, adoption"]:::phase
  Asset["Reusable asset<br/>SOW, WBS, checklist,<br/>reference pattern"]:::phase
  Contact["Contact path<br/>asset request,<br/>consulting discussion"]:::outcome
...
| Review security modernization | [Security Overview](../security/overview) | Zero Trust, Defender, Purview, Conditional Access, Intune |
